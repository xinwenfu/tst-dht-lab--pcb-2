...
**Notes**: 
* The [esp-idf-lib](https://github.com/UncleRus/esp-idf-lib) components are included utilizing the *EXTRA_COMPONENT_DIRS* in the [CMakeLists.txt](./CMakeLists.txt) file. This occurs in multiple labs.
